...
@app.get("/breeze-health", tags=["Health"]) 
...
@app.get("/kite-health", tags=["Health"])
...
@app.get("/api/webhook/metrics", tags=["Webhook"])
...
@app.post("/kite/auto-login", tags=["Auto Login"])
...
@app.post("/broker/auto-login", tags=["Auto Login"]) 

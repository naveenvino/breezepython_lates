            ...
            with sqlite3.connect(self.db_path) as conn:
                ...
                if existing:
                    ...
                    """, (
                        ...
                        config.get('email_to', ''),
                        config.get('alert_trade_entry', True),
                        config.get('alert_trade_exit', True),
                        config.get('alert_stop_loss', True),
                        config.get('alert_risk_warnings', True),
                        config.get('alert_daily_summary', False),
                        config.get('exit_day_offset', 0),
                    ...
                    cursor.execute("""
                        INSERT INTO TradeConfiguration (
                            ...
                            alert_trade_entry, alert_trade_exit, alert_stop_loss,
                            alert_risk_warnings, alert_daily_summary,
